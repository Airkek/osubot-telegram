...
const buildHomePage = (l: ILocalizer & { isFromOwner?: boolean }): IHelpPage => {
...
const buildStaticPage = (l: ILocalizer, textKey: string, backTo: HelpPageId = "home"): IHelpPage => {
    return {
        text: l.tr(textKey),
...
const buildServerListPage = (l: ILocalizer, modules: Module[], slugs: string[], titleKey: string): IHelpPage => {
...
const buildServerPage = (l: ILocalizer, modules: Module[], serverSlug: string): IHelpPage => {
...
const buildModuleCommandsPage = (l: ILocalizer, module: Module, titleKey: string): IHelpPage => {

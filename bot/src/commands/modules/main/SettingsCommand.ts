...
import { OrdrSkinsProvider } from "games/osu/replays/rendering/OrdrSkinsProvider";
...
function buildPlaceholderButton(text: string): IKeyboardButton {
    return {
        text,
        command: "nothing",
    };
...
function buildChatPageButton(chatId: number, page: ChatSettingsPage, text: string, pageNum?: number): IKeyboardButton {
    return {
        text,
...
function buildChatSettingsKeyboard(settings: IChatSettings, l: ILocalizer): IKeyboard {
...
function buildUserLanguagePage(settings: IUserSettings, l: ILocalizer): IKeyboard {
...
async function buildOutputTypePage(settings: IUserSettings, ctx: IMessageContext): Promise<IKeyboard> {
...
function buildChatLanguagePage(settings: IChatSettings, l: ILocalizer): IKeyboard {
...
async function buildRenderPage(settings: IUserSettings, l: ILocalizer): Promise<IKeyboard> {
...
async function buildSkinSelector(settings: IUserSettings, pageNum: number, l: ILocalizer): Promise<IKeyboard> {
...
export class SettingsCommand extends Command {
    constructor(module: Module) {
        super(["settings", "ыуеештпы", "s", "ы"], module, async (ctx: IMessageContext, self, args) => {
            ...
            const showPage = async (
                ...
                switch (page) {
                    ...
                    case "render_advanced": {
                        answer = buildAdvancedRenderPage(settings, customCtx);
                        break;
                    }
                    case "language": {

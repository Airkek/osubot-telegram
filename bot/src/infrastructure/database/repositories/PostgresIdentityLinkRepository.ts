...
export class PostgresIdentityLinkRepository implements IIdentityLinkRepository {
    constructor(private readonly db: ISqlDatabase) {}

    async createToken(accountId: number): Promise<IIdentityLinkToken> {
    ...
    private async mergeUsers(transaction: ISqlExecutor, sourceUserId: number, targetUserId: number): Promise<void> {
        await transaction.run(
    ...
    private async lockUsers(transaction: ISqlExecutor, firstUserId: number, secondUserId: number): Promise<void> {
    ...
    private async deleteToken(transaction: ISqlExecutor, code: string): Promise<void> {

...
import { BotIdentity, MediaReferenceCache } from "../core/ApplicationStorage";
...
import { VKMediaAttachmentProvider } from "./MediaAttachmentProvider";
import { VKMessageContext } from "./MessageContext";
import { VK_UPLOAD_TIMEOUT_MS, VK_VIDEO_UPLOAD_TIMEOUT_MS } from "./Upload";
...
export class VKBotAdapter implements PlatformAdapter {
    ...
    constructor(
        private readonly config: VKBotConfig,
    ...
    createMediaAttachmentProvider(mediaReferences: MediaReferenceCache): VKMediaAttachmentProvider {
    ...
    async start(runtime: ApplicationRuntime): Promise<BotIdentity> {
